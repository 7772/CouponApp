...
export const NavigatorMyPage = StackNavigator(routeConfiguration,stackNavigatorConfiguration)

export const NavigatorMyPageReducer = (state, action) => {
  return NavigatorMyPage.router.getStateForAction(action,state)
}
